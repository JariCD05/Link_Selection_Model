...
class applicable_links():
    ...
    def applicability(self, geometrical_output, time, step_size=1.0):
        ...
        return self.applicable_output, self.applicable_total_output, self.sats_visibility, self.sats_applicable

    def visualize_satellite_visibility(self, sats_visibility, time, num_satellites):
        ...
        plt.grid(True)
        plt.yticks(range(0, num_satellites + 1))
        plt.show()
...
#Links_applicable.visualize_satellite_visibility(sats_visibility= Links_applicable.sats_visibility, time=time, num_satellites=num_satellites)
#print(applicable_output['time'])
print(len(applicable_output['pos SC']))
#print(len(time))


print("Length of visible sattelite array", len(sats_visibility))
