...
if link_number == 'all':
    ...
    time_links     = applicable_output['time'      ][link_number]
    time_links_hrs = time_links / 3600.0
    ranges         = applicable_output['ranges'    ][link_number]
    elevation      = applicable_output['elevation' ][link_number]
    zenith         = applicable_output['zenith'    ][link_number]
    slew_rates     = applicable_output['slew rates'][link_number]
    heights_SC     = applicable_output['heights SC'][link_number]
    heights_AC     = applicable_output['heights AC'][link_number]
    speeds_AC      = applicable_output['speeds AC' ][link_number]
