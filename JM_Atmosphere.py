...
class JM_turbulence:
    def __init__(self,
        ...
        #convert to nparray
        self.height_profiles = np.array(self.height_profiles)
        self.h_cruise = np.array(self.h_cruise)
        self.h_sc = np.array(h_SC)
        ...
        w_r = beam_spread_jari(self.angle_div, self.ranges)  # beam radius at receiver (without turbulence) (in m)
