...
for index in range(len(time)):
    ...
    penalized_latency_data_transfer_performance = Latency_data_transfer_performance_instance.calculate_latency_data_transfer_performance()  
    normalized_penalized_latency_data_transfer_performance = Latency_data_transfer_performance_instance.calculate_latency_data_transfer_performance()  
    ...
    if active_satellite == 'No Link':
        ...
        normalized_penalized_values = [normalized_penalized_availability_performance, normalized_penalized_BER_performance, normalized_cost_performance, normalized_latency_performance, normalized_penalized_latency_data_transfer_performance, normalized_penalized_throughput_performance]
