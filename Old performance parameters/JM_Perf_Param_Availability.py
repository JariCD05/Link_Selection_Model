...
class Availability_performance():
    def __init__(self, time, availability_vector,lengths):
    ...
    def calculate_availability_performance(self):
        ...
        self.availability_performance = [[0 for _ in range(length)] for length in self.lengths]
        print(self.availability_performance)
        print(self.availability_vector)
        for s in range(num_satellites):
            ...
            for index in range(first_one_index, len(self.lengths)):
